...
<!--        </el-form-item>-->
        ...
        <el-table :data="checkItemDetailList" :row-class-name="rowCheckItemDetailIndex" @selection-change="handleCheckItemDetailSelectionChange" ref="checkItemDetail">
          ...
          <el-table-column label="厂房名称" prop="factoryId">
            <template slot-scope="scope">
              <el-input v-model="scope.row.factoryId" placeholder="请输入厂房名称" />
            </template>
          </el-table-column>
          <el-table-column label="房间编号" prop="roomId">
            <template slot-scope="scope">
              <el-input v-model="scope.row.roomId" placeholder="请输入房间编号" />
            </template>
          </el-table-column>
          <el-table-column label="设备编号" prop="inputCode">
            <template slot-scope="scope">
              <el-input v-model="scope.row.inputCode" placeholder="请输入设备编号" />
            </template>
          </el-table-column>
          <el-table-column label="设备类型" prop="type">
            <template slot-scope="scope">
              <el-input v-model="scope.row.type" placeholder="请输入设备类型" />
            </template>
          </el-table-column>
          ...
          <el-table-column label="检查人姓名" prop="checkUser">
            <template slot-scope="scope">
              <el-input v-model="scope.row.checkUser" placeholder="请输入检查人姓名" />
            </template>
          </el-table-column>
